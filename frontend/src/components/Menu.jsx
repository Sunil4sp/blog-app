...
const Menu = ({setMenu}) => {
  ...
  return (
    <div className="bg-aqua w-[160px] z-10 flex flex-col items-start absolute md:rounded-md p-4 space-y-4 shadow-inner bg-slate-50 hover:bg-blend-darken">
      ...
      {/* Logout button is always visible if the user is logged in */}
        <h3
          className="text-black text-sm hover:text-gray-500 cursor-pointer hover:font-bold"
